                    ...
                    <div class="col-auto">
                        <div class="card card-plain">
                            <div class="card-body py-2 px-0 position-relative">
                                <div data-bs-toggle="tooltip" data-time="${SysDate().FUTC(n.created_time).TSPAN_NUM()}" title="${SysDate().FUTC(n.created_time).TimeText()}" class="con_itemsend text-dark mb-1">
                                    ${o}
                                    ${e}
                                    ${r}
                                    ${f}
