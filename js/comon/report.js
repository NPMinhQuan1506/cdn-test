                                ...
                                callbacks: {
                                    label: function (context) {
                                        ...
                                        if (context.parsed !== null) {
                                            label+=NumberToStringUnit(context.parsed,2,true);
    ...
    new Promise((resolve, reject) => {
        ...
        if (document.getElementById(id) != null) {
            ...
            for (let i = 0; i < dataColumn.length; i++) {
                let label= decodeHtmlEntity(dataColumn[i]["label"]);
                        ...
                        tooltip: {
                            callbacks: {
                                label: function (context) {
                                    ...
                                    if (context.parsed.y !== null) {
                                        label+=NumberToStringUnit(context.parsed.y,2,true) ;
                                    }
                                    return label;
                                }
                            }
                    ...
                    scales: {
                        y: {
                            ...
                            ticks: {
                                ...
                                ,callback: function(value,index,ticks) {
                                    return NumberToStringUnit(value,2,true);
                                }
                            }
                        },
                        x: {
        ...
        if (document.getElementById(id) != null) {
            ...
            let config = {
                ...
                data: {
                    ...
                    datasets: [{
                        type: "bar",
                        label: decodeHtmlEntity(labelbar),
                        weight: 5,
                        tension: 0.4,
                        borderWidth: 0,
                    ...
                    {
                        type: "line",
                        label: decodeHtmlEntity(labelline),
                        tension: 0.4,
                        borderWidth: 0,
                        pointRadius: 0,
...
function rp_radar(id, data, textName, dataColumn) {
    let ctx3 = document.getElementById(id).getContext("2d");
    let data_Header = [];
    for (let i = 0; i < data.length; i++) {
        data_Header.push(data[i][textName]);
    ...
    for (let i = 0; i < dataColumn.length; i++) {
        ...
        e.fill = true;
        e.weight = 5;
        e.backgroundColor = `${colorChart[i % colorChart.length]}33`;
        e.borderColor = colorChart[i % colorChart.length];
        e.pointBackgroundColor = colorChart[i % colorChart.length];
        e.pointHoverBorderColor = colorChart[i % colorChart.length];
        e.pointBorderColor = "#fff";
        e.pointHoverBackgroundColor = "#fff";
        datasets.push(e);
    }
...
async function rp_funnel(id,data,textName,valueName) {
    new Promise((resolve,reject) => {
        if(document.getElementById(id)!=null) {
            ...
            for(let i=0;i<data.length;i++) {
                let e={};
                e.y=Number(data[i][valueName]);
                e.label=decodeHtmlEntity(data[i][textName]);
                dataPoints.push(e);
