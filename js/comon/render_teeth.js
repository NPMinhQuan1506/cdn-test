        ...
        if (Number(isdenture) == 0) {
            ...
            if (data && data.length > 0) {
                ...
                for (var i = _from; i < _to; i++) {
                    ...
                    let tr =
                        ...
                        + '<input class="form-check-input pr-2 checkTeeth front" data-type=' + TeethType + ' value=' + item.ID + ' type="checkbox">'
            ...
            if (data && data.length == 2) {
                ...
                let tr =
                    ...
                    + '<input class="form-check-input pr-2 checkTeeth" data-type=' + TeethType + ' value=' + item.ID + ' type="checkbox">'
            ...
            if (data && data.length > 0) {
                ...
                for (var i = _from; i < _to; i++) {
                    ...
                    let tr =
                        ...
                        + '<div class="form-check ">'
                        + '<input class="form-check-input pr-2 checkTeeth bellow" data-type=' + TeethType + ' value=' + item.ID + ' type="checkbox">'
                        + '<label class="custom-control-label font-weight-normal checkTeeth_label" ></label>'
                        + '</div>'
