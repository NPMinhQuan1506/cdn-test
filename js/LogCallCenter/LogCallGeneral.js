        ...
        if (dtConnect.Type != undefined) {
            switch (dtConnect.Type) {
                ...
                case 16:
                    ...
                    break;
                case 17:
                    dtLog = AllLog_Mitek(dtConnect.APIbaseurl, dtConnect.Api_Key, dateFrom, dateTo, extension, page, dtConnect.Limit);
                    break;
                case 18:
                    dtLog = AllLog_CareSoft(dtConnect.APIbaseurl, dtConnect.Api_Key, dateFrom, dateTo, extension, page, dtConnect.Limit);
                    break;
                default:
