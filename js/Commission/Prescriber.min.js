            ...
            AjaxJWT(url = "/api/Commission/RevenueSettings?ver=" + settings.Ver
                ...
                , success = function (result) {
                    ...
                    if (result != "" && result != "null") {
                        ...
                        settings.IsConDevide = Number(_item.Prescriber_Devide);
                        settings.IsConDeposit = Number(_item.Prescriber_Deposit);
                        settings.IsConCostLabo = (Number(_item.Prescriber_CostLabo) > 0 ? 1 : 0);
                        settings.IsConCostComsum = (Number(_item.Prescriber_CostComsum) > 0 ? 1 : 0);
                        settings.IsConCostVat = (Number(_item.Prescriber_CostVat) > 0 ? 1 : 0);
                        settings.IsConCostIns = (Number(_item.Prescriber_CostIns) > 0 ? 1 : 0);
